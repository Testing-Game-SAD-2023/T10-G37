...
echo "Il file $filename è stato creato con successo."
	...
	#Creazione cartella per contenere il report generato da evosuite
	mkdir -p ../FolderTree/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestReport 
	mv evosuite-report/statistics.csv ../FolderTree/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestReport

	#Creazione cartella per contenere il codice sorgente del test ottenuto
	mkdir -p ../FolderTree/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestSourceCode #ADD
	mv I${var}/evosuite-tests ../FolderTree/$NOME_CLASSE/RobotTest/EvoSuiteTest/0${cont}Level/TestSourceCode
